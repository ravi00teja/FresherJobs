package com.niit.fresherjobs.config;
...
import com.niit.fresherjobs.model.ForumComment;
import com.niit.fresherjobs.model.Friend;
import com.niit.fresherjobs.model.Job;
import com.niit.fresherjobs.model.Users;

@Configuration
@ComponentScan("com.niit.fresherjobs.*")
...
public class ApplicationContextConfig {
	...
	public DataSource getOracleDataSource() {
		...
		dataSource.setUsername("admin"); // Schema name
